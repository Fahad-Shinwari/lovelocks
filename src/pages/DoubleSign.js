...
function DoubleSign() {
  const { selected } = useContext(LockContext);
    ...
    return (
        ...
        <div className="row signin no-gutters">
          <div className="col-md-6">
            ...
            <input type="text" placeholder="Please Enter Your Lover Name" />
            <input type="text" placeholder="Your Lover Wallet Address" />
            <textarea type="text" placeholder="Type a Personal Short Message"  rows="4" cols="50"></textarea>
      ...
      >
        ...
        <div className="d-flex btns justify-content-between">
          <button onClick={openNextModal}>Confirm</button>
